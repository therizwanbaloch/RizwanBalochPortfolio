...
// international style names + realistic reviews
const testimonials = [
  {
    name: "Lucas Meyer",
    avatar: "https://i.pravatar.cc/80?img=21",
    stars: 4.9,
    review: "Contact form of our corporate website was broken. Fixed and redesigned it with a clean UX at a fair price.",
  },
  {
    name: "Sophie Laurent",
    avatar: "https://i.pravatar.cc/80?img=47",
    stars: 4.8,
    review: "Added complete online ordering system to our European café chain website with seamless checkout.",
  },
  {
    name: "Ethan Brooks",
    avatar: "https://i.pravatar.cc/80?img=33",
    stars: 4.7,
    review: "Delivered a fresh new design for our SaaS dashboard and improved page speed dramatically.",
  },
  {
    name: "Elena Schmidt",
    avatar: "https://i.pravatar.cc/80?img=55",
    stars: 4.6,
    review: "Redesigned our hotel booking interface – better UX increased our reservations instantly.",
  },
  {
    name: "Leo Andersson",
    avatar: "https://i.pravatar.cc/80?img=17",
    stars: 4.9,
    review: "Built a custom food delivery prototype for our startup. Great communication & fast turnaround!",
  },
  {
    name: "Ava Müller",
    avatar: "https://i.pravatar.cc/80?img=28",
    stars: 4.8,
    review: "Integrated WhatsApp order button and live chat on our online store. Highly recommended.",
  },
];
...
const Card = ({ testimonial }) => (
  ...
  >
    ...
    {/* stars + numeric rating side by side */}
...
const Testimonials = () => (
  <section className="bg-black text-white py-12 overflow-hidden select-none">
    <div className="max-w-6xl mx-auto px-4 text-center">
      ...
      <p className="text-gray-300 text-lg mb-6">What my clients say</p>
