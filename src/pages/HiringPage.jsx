          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-8">
            {packages.map((pkg, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="relative bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-8 shadow-xl hover:shadow-orange-500/20 hover:scale-[1.02] transition duration-300 flex flex-col"
              >
                ...
                <ul className="text-gray-400 text-sm space-y-3 text-left mb-8 flex-grow">
